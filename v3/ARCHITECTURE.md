...
All seven verticals run as stdlib Python, **24/24 test suites** (`python
...
rail without ever double-paying, and a red-team regression suite pinning 19
adversary-found breaks closed (see `claude/REDTEAM-FINDINGS.md`) — committed.
